    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 bg-gray-900 flex flex-col justify-center px-8 sm:px-16 lg:px-20 py-12 relative">
        <div className="max-w-md w-full mx-auto">
          ...
          {/* Header */}
          <p className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-3">Start for free</p>
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-3">
            Create new account<span className="text-primary-500">.</span>
          </h1>
          <p className="text-gray-400 mb-10">
            Already A Member?{' '}
            <Link to="/signin" className="text-primary-500 hover:text-primary-400 font-medium">
              Log In
            </Link>
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex gap-4 pt-2">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-primary-500 hover:bg-primary-600 text-white py-3.5 rounded-full font-semibold focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
